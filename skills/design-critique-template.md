---
title: Design Critique Template агент
description: Создает структурированные, практические критики дизайна, используя проверенные фреймворки и методологии для оценки UI/UX.
tags:
- design-critique
- ux-review
- design-feedback
