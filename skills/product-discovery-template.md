---
title: Product Discovery Template Generator
description: Enables Claude to create comprehensive product discovery frameworks,
  research plans, and validation templates for product managers and teams.
tags:
- product-management
- user-research
- product-discovery
