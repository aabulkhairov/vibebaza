---
title: Definition of Done Expert агент
description: Создаёт исчерпывающие и практичные критерии Definition of Done для agile-команд и проектов разработки программного обеспечения.
tags:
- agile
- project-management
- quality-assurance
