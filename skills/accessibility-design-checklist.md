---
title: Accessibility Design Checklist агент
description: Предоставляет всесторонние аудиты доступности и чек-листы соответствия для веб и мобильных интерфейсов в соответствии со стандартами WCAG 2.1 AA.
tags:
- accessibility
- wcag
- a11y
